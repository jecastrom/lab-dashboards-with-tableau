...
image::https://user-images.githubusercontent.com/63274055/154444640-7567f385-f965-4a71-bec6-0fec6225396e.png[width=600]

To be able to work with the `customer` data as a `measure`, I duplicated the `customer field then I converted that field as 

image::https://user-images.githubusercontent.com/63274055/154445514-ca27e14c-e937-4c75-93ca-560674124e86.png[width=200]
