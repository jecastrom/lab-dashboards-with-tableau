...
To see which data elements we need to create any plot, on the top right hand side conner click on `Show me` and hover the mouse cursor over the type of plot we want. Then at the bottom we will see the elements we need.
